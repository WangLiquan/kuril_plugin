...
import 'package:kuril_plugin/src/analyzer_plugin/utils/map_utils.dart';
import 'package:glob/glob.dart';

import 'checker/kuril_plugin_checker.dart';

/// Plugin class. Root for all data manipulations in plugin.
class DartKurilPluginAnalyzerPlugin extends ServerPlugin {
  ...
  @override
  String get name => 'Kuril_plugin Check';

  @override
  String get version => '1.0.0-alpha.0';

  DartKurilPluginAnalyzerPlugin(ResourceProvider provider) : super(provider);
  ...
  void _processResult(
    ...
    try {
      if (analysisResult.unit != null &&
        ...
        final kurilPluginChecker = KurilPluginChecker(analysisResult.unit);
        final issues = kurilPluginChecker.kurilPluginErrors();
